...
ローカル65件合格は本番SLAやProduction承認を意味しない。Product Owner、Architecture、Test Lead、Security Reviewerによるレビューと、未実行gate、実IdP、実端末、実クラウドの受入を別途必要とする。
