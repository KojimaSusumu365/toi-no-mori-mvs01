#!/usr/bin/env python3
"""Create fail-closed evidence for the Stage 6R-11 90-test town-readiness gate."""
...
def build_evidence(args: argparse.Namespace, log_bytes: bytes) -> dict[str, object]:
    ...
    return {
        ...
        "measurementScope": "native local Question Forest regression plus Town-readiness boundary checks; no Virtual Town runtime implementation",
...
def write_summary(path: Path, evidence: dict[str, object]) -> None:
    ...
    lines = [
        "# Stage 6R-11 Question Forest Minimum / Town Readiness",
        "",
